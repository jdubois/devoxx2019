...
import com.mycompany.myapp.Devoxx2019App;
 ...
 */
@SpringBootTest(classes = Devoxx2019App.class)
public class CategoryResourceIT {

    private static final String DEFAULT_DEVOXX = "AAAAAAAAAA";
    private static final String UPDATED_DEVOXX = "BBBBBBBBBB";
    ...
    public void createCategory() throws Exception {
        ...
        assertThat(testCategory.getDevoxx()).isEqualTo(DEFAULT_DEVOXX);
    ...
    public void getAllCategories() throws Exception {
        ...
        restCategoryMockMvc.perform(get("/api/categories?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].devoxx").value(hasItem(DEFAULT_DEVOXX)))
    ...
    public void getCategory() throws Exception {
        ...
        restCategoryMockMvc.perform(get("/api/categories/{id}", category.getId()))
            ...
            .andExpect(jsonPath("$.devoxx").value(DEFAULT_DEVOXX))
    ...
    public void updateCategory() throws Exception {
        ...
        Category testCategory = categoryList.get(categoryList.size() - 1);
        assertThat(testCategory.getDevoxx()).isEqualTo(UPDATED_DEVOXX);
